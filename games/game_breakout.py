...
class Player(Rectangle):
    ...
    def start(self):
        self.transform.set_position((int(Ngine.get_display()[0]/2), int(Ngine.get_display()[1]*9/10)))
...
def init_bricks(m,n):
    ...
    brick_width = int(Ngine.get_display()[0]/m)
    brick_height = int(Ngine.get_display()[1]/(3*n))
